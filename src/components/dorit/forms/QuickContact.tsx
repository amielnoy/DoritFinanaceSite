      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
        <div className="lg:col-span-5">
          ...
          <div className="mt-8 flex items-center gap-3 text-primary-foreground/60">
            ...
            <a href="mailto:dorit@govari-fin.co.il" dir="ltr" className="hover:text-highlight transition-colors">dorit@govari-fin.co.il</a>
          </div>
          <a
            href="https://wa.me/972508311776"
            target="_blank"
            rel="noopener noreferrer"
            className="mt-4 inline-flex items-center gap-3 text-primary-foreground/60 hover:text-highlight transition-colors"
          >
        ...
        <div className="lg:col-span-7">
          {sent ? (
            <div className="bg-primary-foreground/5 border border-primary-foreground/15 p-10 text-center">
              ...
              <button
                onClick={reset}
                className="mt-8 text-sm tracking-wide underline underline-offset-4 hover:text-highlight transition-colors"
              >
                שליחת הודעה נוספת
              </button>
            </div>
            ...
            <div className="bg-primary-foreground/5 border border-primary-foreground/15 p-8 md:p-10">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-primary border border-primary-foreground/15 px-4 py-3 text-primary-foreground placeholder:text-primary-foreground/30 focus:outline-none focus:border-highlight focus:ring-2 focus:ring-highlight/40 transition-colors"
                  />
                </div>
                <div>
              ...
              <div className="mt-5">
                ...
                <textarea
                  ...
                  className="w-full bg-primary border border-primary-foreground/15 px-4 py-3 text-primary-foreground placeholder:text-primary-foreground/30 focus:outline-none focus:border-highlight focus:ring-2 focus:ring-highlight/40 transition-colors resize-none"
                />
              </div>
